...
# Initialisation of a token to store maximum length of non decreasing subarray.
m = 1

# Initialisation of a token to store current maximum length of non decreasing subarray.
count = 1
