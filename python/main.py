...
# Initialisation of a token to store maximum length of increasing subarray.
m = 1

# Initialisation of a token to store current maximum length of increasing subarray.
count = 1
